...
function Nofitication:Notify(nofdebug, middledebug, all)
    ...
    local BGPic = Instance.new("ImageLabel")
    ...
    local BGPic = Instance.new("ImageLabel")
    BGPic.Name = "Background"
    BGPic.Parent = Window
    BGPic.Transparency = 1
    BGPic.AnchorPoint = Vector2.new(0.5, 0.5)
    BGPic.Image = "rbxassetid://18286267006"
    BGPic.BorderSizePixel = 0
    BGPic.Position = UDim2.new(0.5, 0, 0.5, 0)
    BGPic.Size = UDim2.new(0, 50, 0, 50)
    BGPic.ZIndex = 2
